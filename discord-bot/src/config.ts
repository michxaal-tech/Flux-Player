...
if (!process.env.CLAUDE_CODE_OAUTH_TOKEN && !process.env.ANTHROPIC_API_KEY) {
  throw new Error(
    "Set either CLAUDE_CODE_OAUTH_TOKEN (uses your Claude Pro/Max/Team subscription, " +
      "generated by running `claude setup-token`) or ANTHROPIC_API_KEY (metered API " +
      "billing). See discord-bot/README.md."
  );
}
